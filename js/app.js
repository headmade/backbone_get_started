...
(function() {
  var Masks, Questionaire, Router, TBank, Validates, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  Router = (function(_super) {
    ...
    Router.prototype.close_confirm = function() {
      if (confirm("Вы уверены что хотите закрыть анкету?")) {
        return this.navigate("step1", {
          trigger: true
        });
      } else {
        return this.stayOnCurrent();
      }
    };
    ...
    Router.prototype.stayOnCurrent = function() {
      return this.navigate("step" + questView.current_step, {
        trigger: false
      });
    };
  ...
  TBank.Form3 = (function(_super) {
    __extends(Form3, _super);

    function Form3() {
      _ref4 = Form3.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  TBank.Form4 = (function(_super) {
    __extends(Form4, _super);

    function Form4() {
      _ref5 = Form4.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  Masks.Phone = (function(_super) {
    ...
    function Phone() {
      _ref6 = Phone.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  Masks.Date = (function(_super) {
    ...
    function Date() {
      _ref7 = Date.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  Masks.Pasportseria = (function(_super) {
    ...
    function Pasportseria() {
      _ref8 = Pasportseria.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  Masks.Pasportcode = (function(_super) {
    ...
    function Pasportcode() {
      _ref9 = Pasportcode.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  Masks.Pasportnumber = (function(_super) {
    ...
    function Pasportnumber() {
      _ref10 = Pasportnumber.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  Validates.Email = (function(_super) {
    ...
    function Email() {
      _ref11 = Email.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  Validates.Name = (function(_super) {
    ...
    function Name() {
      _ref12 = Name.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  Validates.Phone = (function(_super) {
    ...
    function Phone() {
      _ref13 = Phone.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
  ...
  Validates.Date = (function(_super) {
    ...
    function Date() {
      _ref14 = Date.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
  ...
  Validates.Country = (function(_super) {
    ...
    function Country() {
      _ref15 = Country.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
  ...
  Validates.Latinname = (function(_super) {
    ...
    function Latinname() {
      _ref16 = Latinname.__super__.constructor.apply(this, arguments);
      return _ref16;
    }
  ...
  Validates.Pasportseria = (function(_super) {
    ...
    function Pasportseria() {
      _ref17 = Pasportseria.__super__.constructor.apply(this, arguments);
      return _ref17;
    }
  ...
  Validates.Pasportnumber = (function(_super) {
    ...
    function Pasportnumber() {
      _ref18 = Pasportnumber.__super__.constructor.apply(this, arguments);
      return _ref18;
    }
  ...
  Validates.Pasportcode = (function(_super) {
    ...
    function Pasportcode() {
      _ref19 = Pasportcode.__super__.constructor.apply(this, arguments);
      return _ref19;
    }
  ...
  Validates.Simpletext = (function(_super) {
    ...
    function Simpletext() {
      _ref20 = Simpletext.__super__.constructor.apply(this, arguments);
      return _ref20;
    }
  ...
  Validates.Commontext = (function(_super) {
    ...
    function Commontext() {
      _ref21 = Commontext.__super__.constructor.apply(this, arguments);
      return _ref21;
    }
  ...
  Validates.Anytext = (function(_super) {
    ...
    function Anytext() {
      _ref22 = Anytext.__super__.constructor.apply(this, arguments);
      return _ref22;
    }
  ...
  Validates.Adress = (function(_super) {
    ...
    function Adress() {
      _ref23 = Adress.__super__.constructor.apply(this, arguments);
      return _ref23;
    }
  ...
  Validates.Adressnum = (function(_super) {
    ...
    function Adressnum() {
      _ref24 = Adressnum.__super__.constructor.apply(this, arguments);
      return _ref24;
    }
  ...
  Validates.Number = (function(_super) {
    ...
    function Number() {
      _ref25 = Number.__super__.constructor.apply(this, arguments);
      return _ref25;
    }
  ...
  Validates.Codeword = (function(_super) {
    ...
    function Codeword() {
      _ref26 = Codeword.__super__.constructor.apply(this, arguments);
      return _ref26;
    }
  ...
  Validates.Checkcode = (function(_super) {
    ...
    function Checkcode() {
      _ref27 = Checkcode.__super__.constructor.apply(this, arguments);
      return _ref27;
    }
  ...
  TBank.Layout = (function(_super) {
    ...
    function Layout() {
      this.commitStep = __bind(this.commitStep, this);
      this.gotoStep = __bind(this.gotoStep, this);      _ref28 = Layout.__super__.constructor.apply(this, arguments);
      return _ref28;
    }
    ...
    Layout.prototype.render = function() {
      ...
      (_base = this.models)[_name = this.current_step - 1] || (_base[_name] = eval("new TBank.Form" + this.current_step));
      (_base1 = this.views)[_name1 = this.current_step - 1] || (_base1[_name1] = eval("new " + this.namespace + ".Step" + this.current_step + "({el: '" + this.els[this.current_step - 1] + "', model: this.models[this.current_step - 1] })"));
      this.views[this.current_step - 1].render();
    ...
    Layout.prototype.commitStep = function(step) {
      return this.views[step - 1].commit();
    };
  ...
  TBank.StepView = (function(_super) {
    ...
    function StepView() {
      _ref29 = StepView.__super__.constructor.apply(this, arguments);
      return _ref29;
    }
  ...
  Questionaire.Layout = (function(_super) {
    ...
    function Layout() {
      _ref30 = Layout.__super__.constructor.apply(this, arguments);
      return _ref30;
    }

    Layout.prototype.els = ['.formBlock1', '#maf_full_form_main .step1', '#maf_full_form_main .step2', '#maf_full_form_main .step3'];
    ...
    Layout.prototype.toSecondStep = function() {
      if (this.commitStep(1)) {
        return router.navigate("step2", {
          trigger: true
        });
      }
    };
    ...
    Layout.prototype.afterRender = function() {
      ...
      switch (step) {
        ...
        case 3:
          ...
          return $("#prev_step_submit").attr("href", "#step2").show();
        case 4:
          $(".formBlock2").slideDown(300);
          $("#first_step_submit").hide();
          $(".sendAgain").show();
          ...
          $("#other_step_submit").attr("href", "#step4");
          return $("#prev_step_submit").attr("href", "#step3").show();
      }
    };

    Layout.prototype.setProgressbar = function(step) {
      var p_width;

      p_width = 75 + 235 * (step - 1);
      return $(".switcher .progress").animate({
        width: p_width
      }, "slow", function() {
        return $(".switcherBlock").find(".item").removeClass("activeSwitcher").eq(step - 1).addClass("activeSwitcher");
      });
    };
  ...
  Questionaire.Step1 = (function(_super) {
    ...
    function Step1() {
      _ref31 = Step1.__super__.constructor.apply(this, arguments);
      return _ref31;
    }
  ...
  Questionaire.Step2 = (function(_super) {
    ...
    function Step2() {
      _ref32 = Step2.__super__.constructor.apply(this, arguments);
      return _ref32;
    }
  ...
  Questionaire.Step3 = (function(_super) {
    ...
    function Step3() {
      _ref33 = Step3.__super__.constructor.apply(this, arguments);
      return _ref33;
    }
  ...
  Questionaire.Step4 = (function(_super) {
    __extends(Step4, _super);

    function Step4() {
      _ref34 = Step4.__super__.constructor.apply(this, arguments);
      return _ref34;
    }
